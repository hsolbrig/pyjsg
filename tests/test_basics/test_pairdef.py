...
tests = [("x1 : INT", ['x1: INT = None'], ['self.x1 = x1'], "pairDef: x1 : valueType: LEXER_ID_REF: INT"),
         ...
         ("x3 : INT+", ['x3: List[INT] = None'], ['self.x3 = jsg_array.JSGArray(_CONTEXT, INT, 1, None, x3)'],
          "pairDef: x3 : valueType: LEXER_ID_REF: INT+"),
         ("x4 : INT*", ['x4: List[INT] = None'], ['self.x4 = jsg_array.JSGArray(_CONTEXT, INT, 0, None, x4)'],
         ...
         ("x7 : INT{1,}", ['x7: List[INT] = None'], ['self.x7 = jsg_array.JSGArray(_CONTEXT, INT, 1, None, x7)'],
          "pairDef: x7 : valueType: LEXER_ID_REF: INT{1,}")]

builtins = [("k : @string", ["k: str = None"], ['self.k = jsg.String(k)'],
             'pairDef: k : valueType: builtinValueType: jsg.String')]
...
class PairDefTestCase(unittest.TestCase):
    ...
    def test_pairdef_shorthand(self):
        ...
        self.assertEqual(['self.x1 = jsg_array.JSGArray(_CONTEXT, jsg.Number, 3, 17, x1)',
                          "setattr(self, 'v 2', jsg_array.JSGArray(_CONTEXT, jsg.Number, 3, 17, "
                          "jsg.Number(_kwargs.pop('v 2', None)))",
                          'self.class = jsg_array.JSGArray(_CONTEXT, jsg.Number, 3, 17, class_)'], t.initializer())
        ...
        self.assertEqual(['self.x1 = jsg.Boolean(x1)', "setattr(self, 'v 2', jsg.Boolean(_kwargs.pop('v 2', None)))",
                          'self.class = jsg.Boolean(class_)'], t.initializer())
        ...
        self.assertEqual(['self.x1 = jsg.JSGNull(x1)', "setattr(self, 'v 2', jsg.JSGNull(_kwargs.pop('v 2', None)))",
                          'self.class = jsg.JSGNull(class_)'], t.initializer())
