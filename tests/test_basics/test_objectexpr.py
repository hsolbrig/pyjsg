...
r3 = """class k(JSGObject):
    ...
    def __init__(self,
                 ...
                 **_kwargs: Dict[str, object]):
        self._context = _CONTEXT
        self.a = Integer(opt_.a) if isinstance(opt_, _Anon1_1_) else Integer(None)
        self.b = String(opt_.b) if isinstance(opt_, _Anon1_1_) else String(None)
        self.c = Integer(opt_.c) if isinstance(opt_, _Anon1_2_) else Integer(None)
        self.d = String(opt_.d) if isinstance(opt_, _Anon1_3_) else String(None)
        super().__init__(self._context, **_kwargs)"""
